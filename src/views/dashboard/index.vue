  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <ImageHoder :src="avatar" width="100px" height="100px" />
          </div>
        ...
        <el-card class="box-card">
          ...
          <el-calendar v-model="value">
            <template #dateCell="{date, data}">
              ...
              <div>
                <span class="date">{{ data.day.substring(8) }}</span>
                <span v-if=" test(date,data)" class="week"> {{ test(date,data) }}</span></div>
            </template>
          </el-calendar>
        </el-card>
        <!-- 公告 -->
...
export default {
  ...
  methods: {
    test(date, data) {
      ...
      if (week === 0 || week === 6) {
        this.week = data.isSelected = true
        return '休'
      }
    }
  }
